...
<body class="home-page home-01 ">
										...
										@if (Auth::user()->utype === 'ADM')
											<li class="menu-item menu-item-has-children parent" >
												...
												<ul class="submenu curency" >
													...
													<li class="menu-item" >
														<a title="Categories Home" href="{{ route('admin.homecategories') }}">Manage Categories Home</a>
													</li>
													<li class="menu-item" >
														<a title="Sale Setting" href="{{ route('admin.sale') }}">Manage Sale Settings</a>
													</li>
													<li class="menu-item" >
	...
	<script src="https://cdn.tiny.cloud/1/ykjy1k06hiari96upduywb7sqo8o0lkv64d887p0w5w6pdxl/tinymce/6/tinymce.min.js" referrerpolicy="origin"></script>
    @livewireScripts()
	@stack('scripts')
</body>
</html>