                    ...
                    <ul class="products-cart">
                        @foreach (Cart::instance('cart')->content() as $item)                        
                            <li class="pr-cart-item">
                                ...
                                <div class="delete">
                                    <a href="#" wire:click.prevent="removeItem('{{$item->rowId}}')" class="btn btn-delete" title="">
            ...
            <div class="summary">
                ...
                <div class="checkout-info">
                    <label class="checkbox-field">
                        <input class="frm-input" value="1" type="checkbox" wire:model.live="haveCouponCode"><span>I have coupon code</span>
                    </label>
                    @if($haveCouponCode == 1)
