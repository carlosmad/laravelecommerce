                    ...
                    <div class="wrap-address-billing">
                        ...
                        <div class="billing-address">
                            ...
                            <p class="row-in-form">
                                ...
                                <input type="number" name="phone" value="" placeholder="10 digits format" wire:model="mobilePhone">
                                @error('mobilePhone') <span class="text-danger">{{$message}}</span> @enderror
                            </p>
                            <p class="row-in-form">
                            ...
                            <p class="row-in-form fill-wife">
                                <label class="checkbox-field">
                                    <input name="different-add" id="different-add" value="1" type="checkbox" wire:model.live="ship_to_different_address">
                ...
                <div class="col-md-12">
                    <div class="wrap-address-billing">
                        ...
                        <div class="billing-address">
                            ...
                            <p class="row-in-form">
                                <label for="phone">Phone number<span>*</span></label>
                                <input type="number" name="phone" value="" placeholder="10 digits format" wire:model="s_mobilePhone">
                                @error('s_mobilePhone') <span class="text-danger">{{$message}}</span> @enderror
                            </p>
                            <p class="row-in-form">
                                <label for="add">Line 1:</label>
