        ...
        <div class="row">
            ...
            <div class="col-lg-9 col-md-8 col-sm-8 col-xs-12 main-content-area">
                ...
                <div class="wrap-shop-control">
                    ...
                    <div class="wrap-right">
                        ...
                        <div class="sort-item orderby ">
                            <select name="orderby" class="" wire:model.change="sorting">
                        ...
                        <div class="sort-item product-per-page">
                            <select name="post-per-page" class="use-chosen" wire:model.change="pagesize">
                ...
                <style>
                    ...
                    .product-wish i{color: #cbcbcb;font-size: 16px;}
                    .product-wish i:hover{color: #ff7007;}
                    .fill-heart{color: #ff7007!important;}
                </style>
                <div class="row">
